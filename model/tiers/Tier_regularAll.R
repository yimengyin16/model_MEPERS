...
#' What this file does
#'   - produce the following model inputs for tier "regularAll"
#'     - decrement table
#'     - salary scale
...
#'  - Special plan members, all subplans
...
wgts[wgts$grp == "regular",  "wgt"] <- 0.75 
wgts[wgts$grp == "special",  "wgt"] <- 0.25
